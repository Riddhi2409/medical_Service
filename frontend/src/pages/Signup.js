...
placeholder:text-textColor cursor-pointer"
              ...
              <div className="mb-5 flex items-center gap-3">
                ...
                {selectedFile && <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColo
...
items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg- [#0066ff46] text-headingColor font-semibold rounded-lg truncate cursor-pointer "></label>
