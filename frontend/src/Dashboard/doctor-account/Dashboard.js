...
const Dashboard = ({name,about,qualification,experience }) => {
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 10 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                  clipRule="evenodd"
                ></path>
              </svg>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-[6px]">
                          <span className="flex items-center gap-[6px] ☐ text-headingColor text-[14px] leading-5 lg:text-[16px] lg:leading-6 font-semibold">
                            ...
                            <span className="text-textColor text-[14px] leading-5 lg:text-[16px] lg:leading-6 font-semibold">({data.totalRating})
                            </span>
                      </div>
